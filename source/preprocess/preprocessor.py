...
class Preprocessor:
	...
	def get_clusters(self, doc_list, k_value =2, max_iter=100):
		...
		return cluster_gen.get_clusters()
...
def main():
	...
	ans_clusters = text_preprocessor.get_clusters(ans_tokens,k_value = 3)
	quest_clusters = text_preprocessor.get_clusters(quest_tokens, k_value = 3)
	print("Answer clusters: ")
	for item in ans_clusters:
		print(item)
	print("Question clusters: ")
	for item in quest_clusters:
		print(item)
